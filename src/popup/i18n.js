  ...
  constructor() {
    this.translations = {
      zh: {
        ...
        hideProviderConfirm:
          "确定要隐藏服务商 {provider}？您可以稍后在设置中重新启用它。",
        ...
        checkModelOrKeyOrPermission:
          "请检查模型ID或者API Key，或确认该模型是否有权限使用",
        ...
        customSystemPromptPlaceholder:
          "输入您的自定义系统提示词。这将用于所有AI交互。",
        customSystemPromptHint:
          "此提示词将与默认语言检测提示词结合使用，用于所有AI交互，但快捷操作按钮有自己的特定提示词除外。",
      ...
      en: {
        ...
        apiKeyInvalid:
          "API key is invalid or check if the current selected model is available",
        ...
        modelDisplayNamePlaceholder:
          "Enter model display name (e.g. DeepSeek AI)",
        saveModel: "Save",
        cancelModel: "Cancel",
        modelSaveSuccess: "Model added successfully",
        modelSaveError: "Failed to add model",
        modelValidationError:
          "Model validation failed, this model may not exist or be unavailable",
        ...
        hideProviderConfirm:
          "Are you sure you want to hide {provider}? You can re-enable it later in settings.",
        ...
        saving: "Saving...",
        checkModelOrKeyOrPermission:
          "Please check the model ID or API key, or whether the model is permitted for your account",
        toggleChatShortcut:
          "Use the same shortcut key to open/close the chat window",
        toggleChatTip:
          "💡 You can customize shortcuts to quickly open/close the chat window",
        ...
        customSystemPromptPlaceholder:
          "Enter your custom system prompt here. This will be used for all AI interactions.",
        customSystemPromptHint:
          "This prompt will be combined with the default language detection prompt and used for all AI interactions, except for quick action buttons which have their own specific prompts.",
        customSystemPromptSaveSuccess:
