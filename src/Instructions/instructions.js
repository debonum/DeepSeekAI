const translations = {
  zh: {
    ...
    installationSteps: [
      ...
      "开启快捷按钮功能（用于决定是否出现工具栏，当在网页上划词选择内容时）",
      "设置你偏好的快捷键（用于快捷打开/关闭 AI 会话窗口，无论是否选中文本）",
      "在任意网页上选择文本，开始与 AI 对话！可以点击工具栏里的按钮或者使用快捷键以打开对话窗口",
    ],
    usage: "使用方法",
    quickButton: "快捷按钮使用",
  ...
  en: {
    ...
    installationSteps: [
      ...
      "Enable the Quick Button feature (to decide whether the toolbar appears when selecting text on a webpage)",
      "Set your preferred shortcut keys (for quickly opening/closing the AI conversation window, regardless of whether text is selected)",
      "Select text on the webpage to start a conversation with AI! You can click the button in the toolbar or use the shortcut key to open the chat window",
    ],
    usage: "Usage",
    ...
    tips: "Tips",
    tip1: "💡 Customizable shortcuts for quickly opening/closing the chat window.",
